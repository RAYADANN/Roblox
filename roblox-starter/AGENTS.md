...
**Шаблон систем** (стек, архитектура, CI, VFX/UI kit). Копируй репозиторий в новый проект — жанр и петлю задаёшь ты, не этот starter.

Не копируй геймдизайн чужой игры и не предлагай чужой контент как идеал. Эталон кода — файлы в этом репо (таблица ниже), не внешние проекты.
